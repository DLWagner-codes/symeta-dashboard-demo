/* ============================================================
   ...
   keyed by level (overall / cornerstone / pillar / style /
...
window.SYMETA_INSIGHTS = {
  ...
  people: {
    maya: {
      overall: 'Maya is a classic visionary founder. Her Cognition cornerstone is exceptional — she sees opportunity, frames a compelling future, and translates it into strategy faster than almost anyone on her team. That same outward energy shows up in her Relational pillars, where she inspires and persuades with ease. Her relative growth edge is Action: turning the vision into repeatable operations is where she most benefits from a strong operating partner.',
      cornerstones: {
        ...
        action: 'Solidly in range but her softest cornerstone. Execution (55) trails her other strengths — the ideas are ahead of the operating system that delivers them.',
        relational: 'Strong. High Influence (86) and Collaboration (80) let her rally people around the vision; Direction is healthy.',
        motivational: 'In range. Drive is real, but Autonomy (58) and energy management suggest she leads better with a co-founder sharing the load.',
      },
      pillars: {
    ...
    daniel: {
      overall: 'Daniel is the operating backbone of Northwind. His Action and Motivational cornerstones are excellent — he executes, decides under pressure, and simply does not quit. He complements Maya almost perfectly: where she conceives, he delivers. His development edge is Cognition; Vision (49) is his lowest pillar, so he is at his best executing a direction someone else has set, and should lean on Maya for the "why".',
      cornerstones: {
        cognition: 'Below his other cornerstones. Vision (49) sits at the bottom of the band — Daniel thinks concretely and tactically, which is a strength for delivery but means he relies on others to frame the future.',
        ...
        motivational: 'Excellent. Autonomy (84), Intensity (80) and Tenacity (83) make him relentless and self-driving.',
      },
      pillars: {
        ...
        vision: { summary: 'At the bottom of the benchmark band and his lowest pillar. Not a flaw — a complementary profile — but worth managing deliberately.',
    ...
    priya: {
      overall: 'Priya is the team’s creative engine. Innovation (90) and Resourcefulness (85) are top-tier, and her Cognition is strong throughout — she generates and builds. The clear growth area is Relational: Collaboration (52) and Influence (55) are her lowest pillars, consistent with an independent, heads-down working style. Investing in how she connects and communicates would multiply the impact of her technical strengths.',
      cornerstones: {
        ...
        relational: 'Her development cornerstone. Collaboration (52) and Influence (55) trail — brilliant work can stall if it isn’t shared and championed.',
        motivational: 'Strong and self-sustaining; high Autonomy supports deep work.',
      },
      pillars: {
        ...
        collaboration: { summary: 'In the lower band and her lowest pillar. An independent style is an asset for building but a constraint for a leadership role.',
    ...
    sam: {
      ...
      cornerstones: {
        ...
        motivational: 'The clearest development area, and trending down. Low Intensity (47) points to depleted energy reserves.',
      },
      pillars: {
    ...
    alex: {
      ...
      cornerstones: {
        ...
        motivational: 'Very high Autonomy (86) — self-driving, but in a duo it can read as going it alone.',
      },
      pillars: {
        ...
        collaboration: { summary: 'Below benchmark — a liability, and the single most important pillar to develop given the team structure.',
    ...
    jordan: {
      overall: 'Jordan mirrors Alex more than complements him — high Vision (84), Innovation (80) and Autonomy (83), with low Collaboration (47), Direction (54) and Execution (52). Two strong, independent visionaries with the same gaps is the core finding for Lumen: the team is doubly strong in Cognition and doubly exposed in Action and inward Relational. The priority is structural — role clarity, an execution owner, and deliberate collaboration — not individual development alone.',
      cornerstones: {
        ...
        motivational: 'High Autonomy (83) reinforces the two-founders-pulling-apart dynamic.',
      },
      pillars: {
  ...
  teams: {
    alpha: {
      overall: 'Northwind is a well-composed founding team. Its four members cover all four cornerstones with little wasted overlap: Maya drives Cognition, Daniel owns Action, Priya supplies Innovation, and Sam anchors Relational. The team’s collective profile is balanced and broadly above benchmark — the kind of complementary spread that survives organisational crises.',
      composition: 'Balanced. Each cornerstone has a clear owner, so strengths reinforce rather than duplicate. The averaged wheel hides this — drag individual members in and out to see how each one fills a specific quadrant.',
      complementary: 'Maya × Daniel is the engine: vision and strategy paired with execution and decisiveness. Priya extends the Cognition/Action edge with exceptional Innovation and Resourcefulness. Sam multiplies all of it through best-in-team Collaboration and Influence.',
      conflicts: 'Two watch-items. (1) Priya’s independent, low-Collaboration style can isolate the technical work from the rest of the team. (2) Sam’s Motivational scores — Intensity (47), Tenacity (50) — are the team’s lowest and trending down, a resilience risk concentrated in the person who holds the relationships. Energy management, not capability, is the team’s soft spot.',
      teamHealth: {
    ...
    beta: {
      overall: 'Lumen’s two co-founders are individually impressive and structurally misaligned. Both Alex and Jordan are strong, independent visionaries — high Vision, Innovation and Autonomy — and both are weak in Collaboration, Execution and Direction. The team is doubly strong in Cognition and doubly exposed everywhere delivery and alignment live. This is the most common, and most lethal, early-stage pattern: two of the same person.',
      composition: 'Unbalanced and overlapping. The averaged wheel looks "spiky-strong" on Cognition and visibly thin on Action and inward Relational. Because both founders share the same shape, no one covers the gaps — there is no operator and no clear owner of execution or direction.',
      ...
      conflicts: 'High structural risk. Two very high-Autonomy founders with low Collaboration tend to diverge under pressure and avoid the hard alignment conversations (low Conflict-Tolerance, low Psychological Safety). Combined with no execution owner, the likely failure mode is drift and duplicated effort rather than blow-up.',
      teamHealth: {
  ...
  portfolio: {
    ...
    comparison: 'Northwind covers all four cornerstones with distinct owners; Lumen is doubly strong in Cognition and doubly exposed in Action and inward Relational. On Team Health, Northwind sits ~1.0 point higher on every ABC and is trending up, while Lumen is low and flat. If you are allocating coaching or capital attention, the two teams need very different interventions.',
    recommendations: [
